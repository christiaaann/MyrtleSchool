  ...
  const handleSubmit = async (e) => {
   ...
   return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-4 justify-center w-full items-center'>
      <input className=' px-5 py-2 w-80 outline-none border-2 rounded-lg' type="text" value={fullname} onChange={(e) =>setfullname(e.target.value)} placeholder='firstname.lastname' required />
