...
const Landing = () => {
  return (
    ...
    <Navbar />
     <div id='home' className='h-screen relative bg-no-repeat bg-cover bg-center z-0' style={{backgroundImage: `url(${bg})`}}>
      ...
      <div className=' border h-[50rem] flex items-center'>
       <div className='h-full  flex-col flex justify-center px-20'>
        ...
        <button className='bg-[#FFBD41] px-10 py-4 rounded-full font-bold shadow-md text-white'>Enroll Now</button>
     ...
     {/* programs */}
     <div id='programs' className=' h-[30rem] relative'>
      <h1 className=' w-full text-center text-5xl text-[#57D021] drop-shadow-lg font-bold font-baloo'>Our Programs</h1>  
      ...
      <div className=' absolute flex justify-center items-center h-full w-full'>
         ...
         <div className='bg-neutral-100 w-[38rem] rounded-lg p-5'>
          ...
          <div className='flex text-neutral-600 gap-2 flex-wrap font-baloo font-semibold'>
          <h1 className='border border-black px-5 rounded-lg'>Grade I</h1>
          <h1 className='border border-black px-5 rounded-lg'>Grade II</h1>
          <h1 className='border border-black px-5 rounded-lg'>Grade III</h1>
          <h1 className='border border-black px-5 rounded-lg'>Grade IV</h1>
          <h1 className='border border-black px-5 rounded-lg'>Grade V</h1>
          <h1 className='border border-black px-5 rounded-lg'>Grade VI</h1>
        </div> 
